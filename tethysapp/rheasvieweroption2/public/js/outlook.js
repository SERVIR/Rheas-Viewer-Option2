...
$("#var_table4").select2();
            ...
            if (index != "-1") {
                ...
                if (level == temp & index != -1) {
                    ...
                    ajax_update_database("get-county", {
                        ...
                        "gid": level,
                        "schema": $("#db_table option:selected").val(),
                    }).done(function (data1) {
                        if ("success" in data1) {
    ...
    function add_dssat(data, scale) {
        ...
        select_interaction.on('select', function (e) {
            ...
            console.log(gid);
            temp = gid;
            generate_dssat_graph("#outlook_dssat_plotter_1", gid, $("#var_table3 option:selected").val());
            generate_dssat_graph("#outlook_dssat_plotter_2", gid, $("#var_table4 option:selected").val());
        ...
        selectedFeatures.on('add', function (event) {
            ...
            try {
                ...
                $("#gid").val(gid);
                var schema = $("#db_table option:selected").val();
...
console.log(jsonObj);
    ...
    $(function () {
        ...
        //db = $("#db_table option:selected").val();
       db=$("#db_table option:selected").val();
        region = $("#db_table option:selected").val();
  ...
  mapchange();
        ...
        function mapchange() {
            ...
            //     generate_dssat_graph("#outlook_dssat_plotter_1", "", $("#var_table3 option:selected").val());
            //     generate_dssat_graph("#outlook_dssat_plotter_2", "", $("#var_table4 option:selected").val());
            //     vectorLayer1.setSource(null);
            //     //  vectorLayer2.setSource(null);
            // } else {
