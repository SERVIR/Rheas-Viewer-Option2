...
# from ..app import Rheasvieweroption2
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.rheasvieweroption2"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.rheasvieweroption2.tests.tests"

        To run tests in the Rheasvieweroption2TestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.rheasvieweroption2.tests.tests.Rheasvieweroption2TestCase"

        To run only the test_if_tethys_platform_is_great function in the Rheasvieweroption2TestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.rheasvieweroption2.tests.tests.Rheasvieweroption2TestCase.test_if_tethys_platform_is_great"
...
class Rheasvieweroption2TestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Rheasvieweroption2)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Rheasvieweroption2)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/rheasvieweroption2/')  # The final '/' is essential for all pages/controllers
